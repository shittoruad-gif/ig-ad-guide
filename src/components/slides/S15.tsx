export default function S15() {
  return (
    <section className="slide dark" id="s15">
      <div className="pg-num">15 / 15</div>
      ...
      <div style={{ background: "rgba(124,77,255,.15)", border: "1.5px solid var(--accent)", borderRadius: "12px", padding: "18px", marginBottom: "16px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <a href="#s14" style={{ display: "flex", justifyContent: "space-between", padding: "8px 12px", background: "rgba(255,255,255,.08)", borderRadius: "6px", textDecoration: "none", fontSize: "12px" }}>
            <span style={{ color: "#aaa" }}>LINE対応テンプレート</span>
            <span style={{ color: "var(--accent)", fontWeight: 700 }}>お店側で使う返信文例 →</span>
          </a>
        </div>
      </div>
